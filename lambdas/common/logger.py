...
class XomifyLogger:
    ...
    def __init__(self, log_level: str = "INFO"):
        ...
        if XomifyLogger._initialized and XomifyLogger._logger:
            self.logger = XomifyLogger._logger
            return
            
        self.log_level = log_level.upper()
        
        # Get or create the root logger for xomify
        self.logger = logging.getLogger("xomify")
        ...
        # Cache for reuse
        XomifyLogger._logger = self.logger
        XomifyLogger._initialized = True
